...
- `initial_capital`, `max_positions_bull`, `risk_per_trade_pct`, and `atr_mult` control risk sizing and stops. The engine automatically scales target allocations to ensure the portfolio is 100% fully invested across the top-ranking targets.
